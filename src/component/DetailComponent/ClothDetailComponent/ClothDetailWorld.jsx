            ...
            <div>
              <div>
                <div className="text-left flex flex-col pt-3">
                  <h1 className="text-[36px] font-milonga lg:text-[80px]">
                    {selectedCloth.title}
                  </h1>
                  <h2 className="text-[26px] font-urbanist font-medium ">
                    {selectedCloth.origin}
                  </h2>
                </div>
                <p className="font-urbanist text-base pt-4 lg:text-[24px] lg:tracking-wide lg:leading-8">
