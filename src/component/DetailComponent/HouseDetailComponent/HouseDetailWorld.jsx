...
const HouseDetailWorld = () => {
  return (
    <div className=" bg-GreenWhite w-screen px-8 relative">
      <h1 className="font-milonga text-primary text-4xl py-8 text-center lg:text-5xl">
        World's Record
      </h1>
      <div className="flex flex-col md:flex-row w-[287px  mx-auto md:gap-8  ">
        ...
        />
        <div className="">
          <h1 className="font-urbanist font-bold text-[30px] lg:text-4xl py-5 lg:py-2">
            Rumah adat Mbaru Niang
          </h1>
          <p className="font-urbanist text-[18px] font-semibold lg:text-2xl">
          ...
          <p className="font-urbanist text-base py-3 lg:text-xl">
