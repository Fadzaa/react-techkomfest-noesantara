...
function DetailWorldRecord() {
    ...
    const worldRecordDesktop = <>
        <div className="relative h-[50vh] w-full">
            <img className="absolute h-full w-full" src={foodRendangDesktop} alt="Test"/>
            <div className="absolute w-full h-full px-8 py-4 flex flex-col ">
                <div className=" flex flex-col items-end mb-9">
                    ...
                    <h1 className="font-urbanist font-semibold text-white text-lg">Minangkabau, Sumatra barat,
                        Indonesia</h1>
                </div>
                <div className="flex items-end">
                    <img className="mb-7 me-2" src={iconThropy} alt="Icon Thropy Desktop"/>
                    <h1 className=" font-urbanist font-semibold text-lg text-white rotate-[5deg] mb-1 ">The
                        World's Most
                        Delicious Food by CNN International in 2011, 2017, and 2022.</h1>
                </div>
            </div>
        </div>
        <div className="flex w-full h-[448px]">
            <div className="w-1/3 mt-[-90px] relative ">
                <img className="absolute h-full w-full" src={foodSataiDesktop} alt=""/>
                <div className="absolute h-full w-full py-10 px-8 flex flex-col justify-between">
                    <div className="flex rotate-6 mt-3">
                        ...
                        <h3 className="font-urbanist font-semibold text-white text-base ">Makanan Terpopuler di
                            Dunia oleh TasteAtlas 2019</h3>
                    </div>
                    <div>
                        <h1 className="font-milonga text-white text-[36px]">Satai</h1>
                        <h1 className="font-urbanist font-semibold text-white text-xl">Ponorogo, Jawa Timur,
                            Indonesia</h1>
                    </div>
                </div>
            </div>

            <div className="w-1/3 mt-[-35px] relative ">
                <img className="absolute h-full w-full" src={foodGudegDesktop} alt=""/>
                <div className="absolute h-full w-full py-10 px-8 flex flex-col justify-between">
                    <div className="flex rotate-6 mt-3 ps-10">
                        <img className="me-4" src={iconThropy} alt="Icon Thropy"/>
                        <h3 className="font-urbanist font-semibold text-white text-base ">Makanan Terlezat Di
                            Asia oleh
                            CNN International 2016</h3>
                    </div>
                    <div>
                        <h1 className="font-milonga text-white text-[36px]">Gudeg</h1>
                        <h1 className="font-urbanist font-semibold text-white text-xl">Yogyakarta, DIY,
                            Indonesia</h1>
                    </div>
                </div>
            </div>

            <div className="w-1/3 mt-3 relative">
                <img className="absolute h-full w-full" src={foodTempeDesktop} alt=""/>
                <div className="absolute h-full w-full py-10 px-8 flex flex-col justify-between">
                    <div className="flex rotate-6 mt-3 ps-10">
                        <img className="me-4" src={iconThropy} alt="Icon Thropy"/>
                        <h3 className="font-urbanist font-semibold text-white text-base ">Makanan Tersehat Di
                            Dunia oleh
                            CNN International 2019</h3>
                    </div>
                    <div>
                        <h1 className="font-milonga text-white text-[36px]">Tempe</h1>
                        <h1 className="font-urbanist font-semibold text-white text-xl">Jawa Tengah,
                            Indonesia</h1>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="w-screen  flex flex-col items-center p-8 lg:p-20">
            <h1 className="font-milonga text-4xl lg:text-[96px] text-primary mb-4 lg:mb-10">World's Record</h1>
            <p className="font-urbanist text-base lg:text-2xl text-primaryText text-center leading-8 mb-6">Makanan
                tradisional
                Indonesia
                mencakup beragam hidangan khas yang diwariskan dari generasi ke generasi. Dikenal karena keberagaman
                rempah-rempah</p>
