...
function DetailFoodPage() {
    return (
        <>
            <Navbar/>
            <DetailComponentHero image={bgHeroFood} title={"Traditional Food"} subtitle={"DetailComponent Budaya"} description={"Crafting Memorable Characters, Villains, Magic Systems, and Stories"} />
            <DetailFoodOpinion/>
