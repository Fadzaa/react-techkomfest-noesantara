      ...
      <div className="absolute flex h-screen items-center justify-center px-16">
        <div className="w-1/2 pe-8">
          <div className="flex flex-col">
            <div className="border border-white border-opacity-70 mt-[55px] h-[39px] rounded-[20px] flex  lg:h-[48px] lg:rounded-3xl lg:flex items-center gap-1 lg:gap-5 lg:text-sm lg:mb-5">
              <ion-icon
                name="search-outline"
                style={{
                  fontSize: "24px",
          ...
          <div className="w-[50vw] ">
            <Slider ref={sliderRef} {...settings}>
              {cardList.map((card, index) => (
                <img
                  className={`w-1/2 ${
                    isCurrentSlide() ? "h-[205px]" : "h-[505px]"
                  } rounded-3xl object-cover pe-5`}
                  src={card.image}
    ...
    <div className="h-screen w-screen relative">
      ...
      <div className="absolute h-full w-full">
        <div className="w-full px-5 pt-16">
          <div className="border border-white w-full border-opacity-70  h-[39px] rounded-[20px] flex items-center gap-1">
            <ion-icon
              name="search-outline"
              style={{
                fontSize: "24px",
          ...
          <div className="w-full">
            <Slider ref={sliderRef} {...settings}>
              {cardList.map((card, index) => (
                <img
                  className={`w-[50vw] ${
                    isCurrentSlide() ? "h-[205px]" : "h-[255px]"
